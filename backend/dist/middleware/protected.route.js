        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ;
                    if (!token) {
                        return [2 /*return*/, next(new http_exeption_1.default('Not authorized to access this route', 401))];
                    }
                    ;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, token_service_1.default.verifyToken(token)];
                case 2:
                    decoded = _a.sent();
                ...
                case 4:
                    err_1 = _a.sent();
                    return [2 /*return*/, next(new http_exeption_1.default('Not authorized to access this router', 401))];
                case 5:
                    ;
                    return [2 /*return*/];
            }
